These are files for the Data Incubator challenge problem submission

Matlab files are to solve Problem 1 (random walk)
There is a brute force code for sanity check and a long script that uses Markov chains to solve exactly
...
get_weather_api.py uses an API to get the temperature and rain forecast for 4 cities and generate plots
Samples of these plots are also incuded as png files